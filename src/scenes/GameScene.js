...
export default class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.time.addEvent({
      ...
      callback() {
        const enemy = new ZombieEnemy(
            this, Phaser.Math.Between(0, this.game.config.width),
    ...
    this.time.addEvent({
      ...
      callback() {
        const enemy =
            new WomanEnemy(this, Phaser.Math.Between(0, this.game.config.width),
                           Phaser.Math.Between(0, this.game.config.height));
        this.enemies.add(enemy);
      },
      callbackScope : this,
    ...
    this.time.addEvent({
      delay : 1000,
      callback() {
        const laser = new Bullet(this, this.x, this.y);
